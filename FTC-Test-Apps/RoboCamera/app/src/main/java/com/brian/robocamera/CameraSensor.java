 ...
 * Created by brian
 */
public class CameraSensor implements Camera.PreviewCallback, SurfaceHolder.Callback
{
    ...
    public void onPreviewFrame(byte[] data, Camera camera)
    {
        if(time < SystemClock.uptimeMillis())
        {
            ...
            handler.post(new SuperSimpleDetector(parameters));
        }
    }
